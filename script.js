...
function PlatformManager(){
  ...
  this.colors = ['red', 'yellow', 'blue', 'pink','orange'];
...
InfiniteRunner.setup = function () {
  ...
  this.player = new Player({x: 150, y: 30, width: 40, height: 35 , radius:50 });
